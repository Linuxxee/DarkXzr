...
async def start_atgk():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@TheDarkChats"))
            await idk(functions.channels.JoinChannelRequest(channel="@DarkSpamSupport"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@TheDarkChats"))
            await ydk(functions.channels.JoinChannelRequest(channel="@DarkSpamSupport"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@TheDarkChats"))
            await wdk(functions.channels.JoinChannelRequest(channel="@DarkSpamSupport"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@TheDarkChats"))
            await hdk(functions.channels.JoinChannelRequest(channel="@DarkSpamSupport"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@TheDarkChats"))
            await sdk(functions.channels.JoinChannelRequest(channel="@DarkSpamSupport"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@TheDarkChats"))
            await adk(functions.channels.JoinChannelRequest(channel="@DarkSpamSupport"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@TheDarkChats"))
            await bdk(functions.channels.JoinChannelRequest(channel="@DarkSpamSupport"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@TheDarkChats"))
            await cdk(functions.channels.JoinChannelRequest(channel="@DarkSpamSupport"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@TheDarkChats"))
            await ddk(functions.channels.JoinChannelRequest(channel="@DarkSpamSupport"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@TheDarkChats"))
            await edk(functions.channels.JoinChannelRequest(channel="@DarkSpamSupport"))
...
async def get_users(event):
  ...
  if event.sender_id in SMEX_USERS:
    ...
    if he_ll == "@DarkSpamSupport":
        return await hell.edit("Restricted to invite users from there.")
    elif he_ll == "@TheDarkChats":
        return await hell.edit("Restricted to invite users from there.")
    elif he_ll == "@TheDarkSpam":
        return await hell.edit("Restricted to invite users from there.")
...
Mᴀsᴛᴇʀ:-** **[『 God Lucifer 』](t.me/GodLucifer)**
...
async def Start_Kardo_Bot():
  await event.client.send_message("DarkSpam • XD", "**GOD LUCIFER ON TOP**")
...
print(text)
print("")
print("SMEX! Dark Spammers Started Sucessfully.")
